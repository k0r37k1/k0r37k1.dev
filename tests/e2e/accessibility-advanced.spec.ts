...
test.describe('Blog Accessibility', () => {
	/**
	 * Comprehensive accessibility tests for blog pages
	 * Mirrors portfolio homepage tests for consistency
	 */
	test('blog has no critical accessibility violations', async ({ page, makeAxeBuilder }) => {
	...
	test('blog has no critical or serious violations', async ({ page, makeAxeBuilder }) => {
		await page.goto('/blog');
		await page.waitForLoadState('networkidle');
	...
	test('blog language switching maintains accessibility', async ({ page, makeAxeBuilder }) => {
		await page.goto('/blog');
		await page.waitForLoadState('networkidle');
	...
	test('blog main content is accessible', async ({ page, makeAxeBuilder }) => {
		await page.goto('/blog');
		await page.waitForSelector('main');
	...
	test('english blog has no violations', async ({ page, makeAxeBuilder }) => {
	...
	test('blog keyboard navigation works', async ({ page, makeAxeBuilder }) => {
		await page.goto('/blog');
