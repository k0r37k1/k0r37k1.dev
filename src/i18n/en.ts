		...
		items: [
			{
				title: 'k0r37k1.dev',
				description:
					'My personal portfolio – modern tech stack, neo-brutalist design. Accessible, DE/EN.',
			...
			},
			{
				title: 'DoZzzy',
				description:
					'Minimalist nap timer for Android. Timer up to 3h, presets, customizable alarm with snooze. Accessible, DE/EN.',
